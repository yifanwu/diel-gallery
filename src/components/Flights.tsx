...
import { DielComponent, OneDimSelection, TwoDimSelection, ChartType, DielComponentProps  } from "diel-ui";
...
export default class Flights extends DielComponent<DielComponentProps> {
